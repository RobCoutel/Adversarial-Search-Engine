...
*******************************************************************************/
    ...
    private static double step = 0.15;
    private static transient ApplicationFunction makeStep = new ApplicationFunction() {
        public double applyFunc(double x, double y) {
            return x - step * y;
        }
    };
...
*******************************************************************************/
    ...
    public static LearningNeuralNetwork loadNeuralNetwork(String path) {
        try {
            FileInputStream fileIn = new FileInputStream(path);
            ObjectInputStream in = new ObjectInputStream(fileIn);
            LearningNeuralNetwork toReturn =
                (LearningNeuralNetwork) in.readObject();
            in.close();
            fileIn.close();
            return toReturn;
